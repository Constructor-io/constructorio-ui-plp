...
Configure how product categories/groups are displayed and behave:

<Canvas of={CioPlpStories.CustomGroupsConfig} />
...
Start with groups section collapsed to save space:

<Canvas of={CioPlpStories.CollapsedGroups} />
...
Completely hide the groups section:

<Canvas of={CioPlpStories.HiddenGroups} />
  ...
  return (
    <CioPlp
      ...
      paginationConfigs={{
        ...
        resultsPerPage: 24          // Override results per page
      }}
