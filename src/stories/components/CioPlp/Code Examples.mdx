...
If you're importing the libary via the [bundle approach](https://github.com/Constructor-io/constructorio-ui-plp?tab=readme-ov-file#using-the-javascript-bundle) 
