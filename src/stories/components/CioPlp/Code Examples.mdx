...
export default function MyComponent() {
  return (
    <CioPlp
      ...
      filterConfigs={{
        renderCollapsed: false,                // When true, all filter groups start collapsed
        ...
        perFacetConfigs: {                     // Per-facet configuration overrides
          color: { collapsed: true },          // Collapse specific facets
        },
      }}
      ...
      sortConfigs={{}}
      // Filter configuration with visual filter support
      filterConfigs={{
