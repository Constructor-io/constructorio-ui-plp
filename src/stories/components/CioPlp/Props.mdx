...
| Property           | Type                                                                        | Description                                            |
| ------------------ | --------------------------------------------------------------------------- | ------------------------------------------------------ |
| groups             | `PlpItemGroup[]`                                                            | The groups data array                                  |
...
| goToGroupFilter    | `(breadcrumb: { path: string; groupId: string; breadcrumb: string }) => void` | Callback to navigate via breadcrumb                  |
